                    ...
                    <form id="formProfile" class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="fullname" class="editable w-full border rounded-lg px-3 py-2"
                            ...
                            <div>
                                ...
                                <input type="text" name="username" class="editable w-full border rounded-lg px-3 py-2"
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="email" class="w-full border rounded-lg px-3 py-2 bg-gray-100"
                            ...
                            <div>
                                ...
                                <input type="text" class="w-full border rounded-lg px-3 py-2 bg-gray-100"
                                    value="<?= $user->gender == 'L' ? 'Laki-laki' : 'Perempuan' ?>" readonly>
                            </div>
                        ...
                        <div class="flex justify-end gap-3 pt-4">
                            ...
                            <button id="btnCancel" type="button"
                                class="px-5 py-2 rounded-lg border border-blue-500 text-blue-500" disabled>
                                Batal
                            </button>

                            <button id="btnSave" type="submit"
                                class="px-5 py-2 rounded-lg bg-blue-300 text-white cursor-not-allowed" disabled>
                                Simpan
                            </button>
